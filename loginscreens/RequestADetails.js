...
export default class RequestADetails extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      counselorName:"",
 ...
 <View style={{backgroundColor:"#ffa576",borderBottomLeftRadius:90,borderBottomRightRadius:90, height:100}}>
    <Text style={{fontWeight:'bold',fontSize:20,marginTop:50,fontFamily:"Times New Roman",textAlign:'center',color:'brown'}}> Answered Request Details</Text>
    </View>
